              ...
              <div key={pathSlug}>
                <div className="rounded-2xl border border-white/15 p-5 sm:p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <span className="font-mono text-[10px] text-[#d9ff5a]">
                        {path.number} / PATH
                      </span>
                    ...
                    <Link
                      ...
                      className="rounded-full border border-white/20 px-3 py-1.5 text-[10px] font-bold transition hover:border-[#d9ff5a] hover:text-[#d9ff5a]"
                    >
                      View path
                    </Link>
                  </div>
                    ...
                    {pathCourses.map((course) => {
                      ...
                      return (
                        <Link
                          ...
                          className={`rounded-lg border p-3 transition hover:border-[#d9ff5a] ${
                            isComingSoon
                        ...
                        >
                          <div className="flex items-center justify-between">
                            ...
                            {isComingSoon && (
                              <span className="ml-2 shrink-0 rounded-full border border-dashed border-[#d9ff5a]/40 px-1.5 py-0.5 text-[8px] font-bold text-[#d9ff5a]/60">
                                Soon
                              </span>
                            )}
                          </div>
                          <span className="mt-1 block text-[10px] text-[#b9c4b9]">
                ...
                {!isLastPath && (
                  <div className="flex justify-center py-3">
                    <ChevronDown className="text-[#d9ff5a]" size={20} />
                  </div>
                )}
              </div>
            );
