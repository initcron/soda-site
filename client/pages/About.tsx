...
export default function About() {
  return (
    <main className="bg-[#f6f3f8]">
      ...
      <section className="page-shell py-20">
        <div className="mx-auto grid max-w-5xl gap-14 lg:grid-cols-[1fr_1.5fr]">
          <div className="space-y-6">
            <div className="overflow-hidden rounded-2xl border border-[#1e1a2e]/15 bg-white">
              <img
              ...
              <div className="p-6">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  <a
                    ...
                    className="inline-flex items-center gap-1 rounded-full border border-[#1e1a2e]/15 px-3 py-1.5 text-[10px] font-bold transition hover:border-[#1e1a2e]"
                  >
            ...
            <div className="grid grid-cols-2 gap-3">
              <img
                ...
                className="rounded-xl border border-[#1e1a2e]/10 object-cover"
              />
              <img
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="mt-3 text-sm leading-7 text-[#5a5066]">
            ...
            <div>
              ...
              <ul className="mt-3 space-y-2 text-sm leading-7 text-[#5a5066]">
                <li className="flex gap-3">
                  <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-[#7b5e8b]" />
            ...
            <div className="rounded-2xl border border-[#1e1a2e]/15 bg-white p-6">
              <div className="flex items-center gap-3">
                <BookOpen size={18} className="text-[#7b5e8b]" />
                <h3 className="font-display text-lg font-extrabold tracking-[-.04em]">
                  Runbooks & Robots
                </h3>
              </div>
              <p className="mt-2 text-sm leading-6 text-[#5a5066]">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="mt-4 inline-flex items-center gap-2 rounded-full bg-[#1e1a2e] px-5 py-2.5 text-xs font-bold text-[#a288b3] transition hover:bg-[#1e1a2e]/90"
              >
      ...
      <section className="border-y border-[#1e1a2e]/10 bg-[#1e1a2e] text-[#f6f3f8]">
        <div className="page-shell py-16">
          <p className="text-center font-mono text-xs text-[#a288b3]">
            TRUSTED BY TEAMS AT
          </p>
