...
export default function About() {
  return (
    <main className="bg-[#f7f7f2]">
      ...
      <section className="page-shell py-20">
        <div className="mx-auto grid max-w-5xl gap-14 lg:grid-cols-[1fr_1.5fr]">
          <div className="space-y-6">
            <div className="overflow-hidden rounded-2xl border border-[#13201e]/15 bg-white">
              <img
            ...
            <div className="grid grid-cols-2 gap-3">
              <img
                ...
                className="rounded-xl border border-[#13201e]/10 object-cover"
              />
              <img
      ...
      <section className="border-y border-[#13201e]/10 bg-[#13201e] text-[#f7f7f2]">
        <div className="page-shell py-16">
          <p className="text-center font-mono text-xs text-[#d9ff5a]">
            TRUSTED BY TEAMS AT
          </p>
