...
export default function Index() {
  return (
    <main>
      {/* Hero — unchanged */}
      <section className="relative border-b border-[#506580]/10 bg-[#ffffff]">
        <div className="page-shell grid min-h-[620px] items-center gap-14 py-20 lg:grid-cols-[1.15fr_.85fr] lg:py-24">
          ...
          <div className="relative mx-auto w-full max-w-[440px] lg:mx-0">
            <div className="absolute -inset-6 rounded-full border border-[#506580]/30"></div>
            <div className="absolute inset-7 rounded-full border border-dashed border-[#506580]/50"></div>
            <Link
              to="/roadmaps"
      ...
      {/* Stats — unchanged */}
      <section className="border-b border-[#506580]/10 bg-[#506580] text-[#ffffff]">
        <div className="page-shell grid grid-cols-2 divide-x divide-white/15 md:grid-cols-4">
          <div className="py-7 pr-4">
            ...
            <p className="mt-1 text-xs text-[#9a9ca4]">learners worldwide</p>
          </div>
          <div className="py-7 px-4">
            <p className="font-display text-3xl font-extrabold tracking-[-.06em]">
              7k+
            </p>
            <p className="mt-1 text-xs text-[#9a9ca4]">course reviews</p>
          </div>
          <div className="py-7 pr-4 pl-0 md:px-4">
            <p className="font-display text-3xl font-extrabold tracking-[-.06em]">
              15+
            </p>
            <p className="mt-1 text-xs text-[#9a9ca4]">technical courses</p>
          </div>
          <div className="py-7 pl-4">
            <p className="font-display text-3xl font-extrabold tracking-[-.06em]">
              4.7/5
            </p>
            <p className="mt-1 text-xs text-[#9a9ca4]">average rating</p>
          </div>
        </div>
        <div className="page-shell pb-4 text-[10px] text-[#6b6d75]">
      ...
      <section className="border-y border-[#506580]/10 bg-[#ffffff]">
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {featuredCourses.map((course) => (
              ...
              >
                ...
                <div className="mt-6 flex items-center justify-between border-t border-[#506580]/10 pt-4 text-xs font-bold">
        ...
        <div className="overflow-hidden rounded-[2rem] bg-[#506580] px-7 py-10 text-[#ffffff] sm:px-12 sm:py-14">
          <div className="grid items-center gap-10 lg:grid-cols-[1fr_.8fr]">
            <div>
              ...
              <p className="mt-5 max-w-xl text-sm leading-6 text-[#b0b2b8]">
      ...
      <section className="border-t border-[#506580]/10 bg-[#f2f2f2]">
