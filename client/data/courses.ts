...
export const courses: Course[] = [
  // --- AI & Agentic Courses (top) ---
  {
    ...
    status: "published",
    shortCode: "AI",
    pathSlugs: ["ai-augmented-devops", "agentic-devops-engineer", "ai-platform-engineer"],
  },
  {
    slug: "ai-driven-iac",
  ...
  // --- Kubernetes Courses (middle) ---
  {
    ...
    status: "published",
    shortCode: "K8",
    pathSlugs: ["kubernetes-platform-engineer"],
  },
  {
  ...
  // --- DevOps Foundational Courses (bottom) ---
  {
  ...
  {
    slug: "ultimate-terraform-bootcamp",
    title: "Ultimate Terraform Bootcamp",
    tagline: "Master Infrastructure as Code with Terraform",
    description:
      "A comprehensive, hands-on bootcamp on HashiCorp Terraform for infrastructure provisioning and management. You will learn to write, plan, and apply Terraform configurations, manage state, build reusable modules, and automate multi-cloud infrastructure deployments following production best practices.",
    level: "Intermediate",
    duration: "20 hours",
    udemyUrl:
      "https://www.udemy.com/course/ultimate-terraform-bootcamp/?referralCode=946530677F8A727632CE",
    outcomes: [
      "Write and organize Terraform configurations with HCL",
      "Manage Terraform state and remote backends",
      "Build reusable modules for infrastructure components",
      "Provision infrastructure across multiple cloud providers",
      "Implement Terraform workflows in CI/CD pipelines",
      "Apply production best practices for IaC at scale",
    ],
    curriculum: [
      { title: "Terraform Fundamentals", description: "HCL syntax, providers, resources, and data sources." },
      { title: "State Management", description: "Local and remote state, locking, and import." },
      { title: "Modules and Reusability", description: "Building composable, shareable infrastructure modules." },
      { title: "Multi-Cloud Provisioning", description: "Working with AWS, Azure, and GCP providers." },
      { title: "Terraform in CI/CD", description: "Automated plan, apply, and drift detection workflows." },
    ],
    rating: "4.6",
    students: "8000",
    status: "published",
  ...
  // --- Coming Soon ---
  {
    slug: "agentic-devops-bootcamp",
    title: "Agentic DevOps Bootcamp",
    tagline: "Build and operate AI-powered DevOps workflows",
    description:
      "Learn to design, deploy, and operate agentic AI systems within DevOps pipelines. From AI-assisted automation to fully autonomous agent workflows, this course bridges the gap between AI capabilities and production-grade DevOps practices.",
    level: "Advanced",
    ...
    curriculum: [
      { title: "Agentic Systems Architecture", description: "Designing production-ready AI agent pipelines" },
    ...
    status: "coming-soon",
    shortCode: "AG",
    pathSlugs: ["agentic-devops-engineer"],
  },
  {
